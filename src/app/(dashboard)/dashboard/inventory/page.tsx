  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4 border-b border-border pb-5">
        ...
        <div className="flex gap-2"><ExportLink type="inventory" label="Export inventory" /><a href="#edit-inventory-section" className="inline-flex items-center gap-2 rounded-[var(--radius-sm)] bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-[0_5px_14px_rgba(15,123,108,0.18)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(15,123,108,0.18)]"><Plus size={16} /> Stock adjustment</a></div>
      </div>
